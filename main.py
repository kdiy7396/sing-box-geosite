...
def parse_list_file(link, output_directory):
    try:
        ...
        df = df[df['pattern'].isin(MAP_DICT.values()) | df['pattern'].isin(MAP_DICT.keys())].reset_index(drop=True)
...
if __name__ == "__main__":
    ...
    # 最后自动生成 Google IP 段规则
    generate_google_rules(output_directory=output_dir)
